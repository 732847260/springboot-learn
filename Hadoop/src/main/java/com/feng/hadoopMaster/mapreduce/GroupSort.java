package com.feng.hadoopMaster.mapreduce;

import com.feng.hadoopMaster.reduce.model.GroupSortModel;
...
//                reduce输出：20	1 1
    ...
    public static void main(String[] args) throws Exception {
        ...
        int ec = ToolRunner.run(new Configuration(), new com.feng.hadoopMaster.mapreduce.SearchStar(), filePath);
        System.exit(ec);
    }
}
