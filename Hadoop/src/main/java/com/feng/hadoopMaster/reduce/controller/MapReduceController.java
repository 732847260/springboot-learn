package com.feng.hadoopMaster.reduce.controller;


import com.feng.hadoopMaster.reduce.service.MapReduceService;
import com.feng.hadoopMaster.vo.BaseReturnVO;
...
public class MapReduceController {
     ...
     * @return
     */
    @PostMapping(value = "/wordCount",produces = { "application/json;charset=UTF-8" } )
